...
export class ReconocimientoFacialComponent implements OnInit {
  ...
  constructor(private fileService: FileService, public dialogRef: MatDialogRef<ReconocimientoFacialComponent>,@Inject(MAT_DIALOG_DATA) public data: Data, private service:AccesoService, private handleError: HandleErrorsService, public router: Router) { 
